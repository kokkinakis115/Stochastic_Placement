...
if __name__ == "__main__":
    ...
    weights = {'cost': 0.5, 'latency': 1, 'relocation': 1}  # Example: prioritize minimizing relocations higher
    ...
    # Relocations_minimizing_results = {"Average Number of Violations": statistics.mean([result['Total Number of Violations'] for result in BS_model_relocations]),
    #                                 "Std Deviation in Number of Violations": statistics.stdev([result['Total Number of Violations'] for result in BS_model_relocations]),
    #                                 "Average Number of Relocations": statistics.mean([result['Total Number of Relocations'] for result in BS_model_relocations]),
    #                                 "Std Deviation in Number of Relocations": statistics.stdev([result['Total Number of Relocations'] for result in BS_model_relocations]),
    #                                 "Average Cost": statistics.mean([result['Total Cost'] for result in BS_model_relocations]),
    #                                 "Std Deviation in Cost": statistics.stdev([result['Total Cost'] for result in BS_model_relocations]),
    #                                 "Average Resource Utilization Percentage": statistics.mean([result['Average Resource Utilization Percentage'] for result in BS_model_relocations]),
    #                                 "Std Deviation in Resource Utilization Percentage": statistics.stdev([result['Average Resource Utilization Percentage'] for result in BS_model_relocations])
    #                                 }
